    ...
    <section class="w-full">
        <div class="flex max-w-5xl m-auto py-[30px] rounded-lg px-4">
            ...
            <div class="w-full p-6">
                <h2 class="text-5xl mb-3 text-white">What is FPS+ Rust Map?</h2>
        ...
        <div class="flex max-w-5xl m-auto py-[30px] rounded-lg px-4">
            <div class="w-full py-6 pr-6">
                <h2 class="text-5xl mb-3 text-white">Combined Outpost & Bandit Camp</h2>
                <p class="mb-4 text-gray-100">The Outpost and Bandit Camp have been consolidated into a single entity, with the Outpost assuming the primary role. This unified location now includes added benefits such as teleportation and comprehensive support for the Monument addons plugin. Please refer to the map description for further details.</p>
