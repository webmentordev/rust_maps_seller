    ...
    <section class="h-[80vh] bg-center bg-cover relative bg-fixed" style="background-image: url({{ asset('assets/header.jpg') }})">
        ...
        <div class="max-w-7xl m-auto py-12 px-4 flex items-center justify-center h-full relative"> 
            <div class="text-center">
                <h1 class="text-6xl text-white mb-3 leading-10">Ultimate Destination for <br> <span class="text-4xl link">Personalized Rust Maps</span></h1>
                {{-- <p class="text-white mb-3">Purchase Exquisite Custom-Built Maps Showcasing Newly Launched Monuments</p> --}}
                <a href="#" class="link py-2 px-4 text-lg text-gray-100 bg-rust inline-block">Collection</a>
            </div>
        </div>
    </section>
    <x-listing />
