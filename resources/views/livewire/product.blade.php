<section>
    <div class="max-w-5xl m-auto px-4 grid grid-cols-2 py-[100px] gap-6">
        <div class="h-fit">
            <a class="h-fit mb-5" href="{{ asset('/storage/'.$product->image) }}" target="_blank" title="{{ $product->title }} Custom Rust Map image" alt="{{ $product->title }} Custom Rust Map image">
                <img src="{{ asset('/storage/'. $product->image) }}" class="w-full h-fit rounded-3xl mb-5" alt="{{ $product->title }} image">
            </a>
        ...
        <div class="bg-dark-100 p-6 rounded-2xl border border-white/10 mb-4 text-sm">
            ...
            <article class="article mb-5">
                ...
                <ul>
                    <li>-------------------------------------</li>
                    <li>Permanent registered on account!</li>
                    <li>Exclusive Map Customize Support</li>
                    <li>Receive map updates</li>
                    <li>No Password</li>
