<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 mt-[50px]">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            <div wire:loading wire:target='createProduct'>
                <x-processing message="Creating...." />
            </div>
                ...
                x-on:livewire-upload-progress="progress = $event.detail.progress">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4">
                        <div class="w-full">
                            ...
                            <x-text-input id="image" class="block mt-1 w-full rounded-none" type="file" wire:model="image" required accept="image/*" />
                            <x-input-error :messages="$errors->get('image')" class="mt-2" />
                        </div>
                        <div class="w-full">
                            <x-input-label for="file" :value="__('Map File')" />
                            <x-text-input id="file" class="block mt-1 w-full rounded-none" type="file" wire:model="file" required />
