    ...
    <div class="max-w-6xl m-auto py-12 px-4">
        <div class="flex 710:flex-col 710:items-start items-center justify-between border-b border-white/10 py-6">
            <div class="w-full max-w-3xl 710:mb-6">
                ...
                <ul class="flex">
                    <li class="mr-3"><a href="{{ route('terms') }}" rel="nofollow" title="Terms Of Service" class="underline text-sm text-rust hover:text-rust-green">Terms Of Service</a></li>
                    <li class="mr-3"><a href="{{ route('policy') }}" rel="nofollow" title="Privacy Policy" class="underline text-sm text-rust hover:text-rust-green">Privacy Policy</a></li>
            ...
            <div class="text-end">
                ...
                <nav class="link text-white">
                    <ul class="flex flex-col 710:text-start">
                        ...
                        <a href="{{ route('maps.fetch') }}">Paid Maps</a>
                        <a href="{{ route('maps.free') }}">Free Maps</a>
                        <a href="{{ route('blogs') }}">Blogs</a>
                        <a href="{{ route('report') }}" rel="nofollow">Report</a>
        ...
        <p class="text-center pt-12 text-white">Copyright &copy; {{ date('Y') }} BuyRustMapsStore | All rights reserved</p>
    </div>
</footer>